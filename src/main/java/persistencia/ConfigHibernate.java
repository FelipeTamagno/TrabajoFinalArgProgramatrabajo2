...
public class ConfigHibernate {
    ...
    public static void load() {
        ...
        try {
            ...
            config.setProperty("hibernate.connection.username", "felipe");
            config.setProperty("hibernate.connection.password", "240313");
            config.setProperty("hibernate.dialect", "org.hibernate.dialect.MySQLDialect");
            config.setProperty("hibernate.show_sql", "true");
            config.setProperty("hibernate.hbm2ddl.auto", "update");//create-drop para crear tabla o update para acutilizar
